...
.method private getPackageLPw(Ljava/lang/String;Lcom/android/server/pm/PackageSetting;Ljava/lang/String;Lcom/android/server/pm/SharedUserSetting;Ljava/io/File;Ljava/io/File;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;IIILandroid/os/UserHandle;ZZLjava/lang/String;Ljava/util/List;)Lcom/android/server/pm/PackageSetting;
    ...
    .line 765
    .local v24, "s":Lcom/android/server/pm/PackageSignatures;
    move-object/from16 v0, p2
    ...
    .line 851
    .end local v24    # "s":Lcom/android/server/pm/PackageSignatures;
    :goto_4
    ...
    .line 721
    .local v21, "allUserInfos":Ljava/util/List;, "Ljava/util/List<Landroid/content/pm/UserInfo;>;"
    if-eqz v21, :cond_4
    ...
    .local v29, "userInfo$iterator":Ljava/util/Iterator;
    :goto_5
    ...
    .line 734
    .end local v21    # "allUserInfos":Ljava/util/List;, "Ljava/util/List<Landroid/content/pm/UserInfo;>;"
    .end local v28    # "userInfo":Landroid/content/pm/UserInfo;
    .end local v29    # "userInfo$iterator":Ljava/util/Iterator;
    :cond_4
    move-object/from16 v0, p7
    ...
    .line 803
    invoke-virtual/range {v4 .. v20}, Lcom/android/server/pm/PackageSetting;->setUserState(IJIZZZZZLjava/lang/String;Landroid/util/ArraySet;Landroid/util/ArraySet;ZII[Ljava/lang/String;)V
    ...
    .line 821
    .local v22, "dis":Lcom/android/server/pm/PackageSetting;
    if-eqz v22, :cond_11
    ...
    invoke-virtual/range {v22 .. v22}, Lcom/android/server/pm/PackageSetting;->getPermissionsState()Lcom/android/server/pm/PermissionsState;
    ...
    .line 856
    .end local v22    # "dis":Lcom/android/server/pm/PackageSetting;
    :cond_12
    if-eqz p14, :cond_13
...
.method readPackageRestrictionsLPr(I)V
    ...
    const-string/jumbo v22, "Cleaning up stopped packages file "
    ...
    .local v33, "pkg$iterator":Ljava/util/Iterator;
    :goto_1
    ...
    .end local v33    # "pkg$iterator":Ljava/util/Iterator;
    :catch_0
    move-exception v26
    ...
    .restart local v33    # "pkg$iterator":Ljava/util/Iterator;
    :cond_1
    return-void
    ...
    const-string/jumbo v22, "No package known for stopped package "
    ...
    .line 1669
    .local v24, "blockedStr":Ljava/lang/String;
    if-nez v24, :cond_c
    ...
    .line 1672
    .local v27, "hiddenStr":Ljava/lang/String;
    if-nez v27, :cond_d
    ...
    .end local v27    # "hiddenStr":Ljava/lang/String;
    ...
    .restart local v27    # "hiddenStr":Ljava/lang/String;
    :cond_d
    ...
    .line 1712
    invoke-virtual/range {v6 .. v22}, Lcom/android/server/pm/PackageSetting;->setUserState(IJIZZZZZLjava/lang/String;Landroid/util/ArraySet;Landroid/util/ArraySet;ZII[Ljava/lang/String;)V
    :try_end_4
    ...
    .end local v20    # "verifState":I
    .end local v21    # "linkGeneration":I
    .end local v24    # "blockedStr":Ljava/lang/String;
    .end local v27    # "hiddenStr":Ljava/lang/String;
    .end local v28    # "maxAppLinkGeneration":I
    .end local v29    # "name":Ljava/lang/String;
    .end local v30    # "outerDepth":I
    ...
    const-string/jumbo v22, "Unknown element under <stopped-packages>: "

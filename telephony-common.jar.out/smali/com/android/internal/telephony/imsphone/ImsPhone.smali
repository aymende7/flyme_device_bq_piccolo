...
.method static synthetic -wrap0(Lcom/android/internal/telephony/imsphone/ImsPhone;I)V
    .locals 0
    .param p1, "data"    # I
...
.method static synthetic -wrap2(Lcom/android/internal/telephony/imsphone/ImsPhone;)V
    .locals 0
...
.method public constructor <init>(Landroid/content/Context;Lcom/android/internal/telephony/PhoneNotifier;Lcom/android/internal/telephony/Phone;Z)V
    ...
    .line 1736
    new-instance v2, Lcom/android/internal/telephony/imsphone/ImsPhone$4;

    invoke-direct {v2, p0}, Lcom/android/internal/telephony/imsphone/ImsPhone$4;-><init>(Lcom/android/internal/telephony/imsphone/ImsPhone;)V

    iput-object v2, p0, Lcom/android/internal/telephony/imsphone/ImsPhone;->mRttReceiver:Landroid/content/BroadcastReceiver;
    ...
    invoke-virtual {v2, p0}, Lcom/android/internal/telephony/TelephonyComponentFactory;->makeImsExternalCallTracker(Lcom/android/internal/telephony/imsphone/ImsPhone;)Lcom/android/internal/telephony/imsphone/ImsExternalCallTracker;
    ...
    invoke-virtual {v2, v3}, Lcom/android/internal/telephony/imsphone/ImsPhoneCallTracker;->registerPhoneStateListener(Lcom/android/internal/telephony/imsphone/ImsPhoneCallTracker$PhoneStateListener;)V
    ...
    invoke-virtual {v2, v3}, Lcom/android/internal/telephony/imsphone/ImsExternalCallTracker;->setCallPuller(Lcom/android/internal/telephony/imsphone/ImsPullCall;)V
    ...
    invoke-virtual {v2, p0, v3, v5}, Lcom/android/internal/telephony/Phone;->registerForServiceStateChanged(Landroid/os/Handler;ILjava/lang/Object;)V
...
.method private canSendRttModifyRequest()Z
    ...
    const-string/jumbo v2, "RTT: imsCall null"
...
.method private checkIfModifyRequestOrResponse(I)V
    ...
    .prologue
    .line 1837
    invoke-virtual {p0}, Lcom/android/internal/telephony/imsphone/ImsPhone;->canProcessRttReqest()Z
    ...
    const-string/jumbo v2, "RTT: checkIfModifyRequestOrResponse data =  "
...
.method private isInFullRttMode()Z
    ...
    const-string/jumbo v4, "RTT: isInFullRttMode mode = "
...
.method private packRttModifyRequestToProfile(I)V
    ...
    const-string/jumbo v3, "RTT: cannot send rtt modify request"
    ...
    invoke-virtual {v2}, Lcom/android/ims/ImsCall;->getCallProfile()Lcom/android/ims/ImsCallProfile;

    move-result-object v0

    .line 1861
    .local v0, "fromProfile":Lcom/android/ims/ImsCallProfile;
    move-object v1, v0

    .line 1862
    .local v1, "toProfile":Lcom/android/ims/ImsCallProfile;
    new-instance v2, Lcom/android/ims/ImsStreamMediaProfile;

    invoke-direct {v2, p1}, Lcom/android/ims/ImsStreamMediaProfile;-><init>(I)V

    iput-object v2, v0, Lcom/android/ims/ImsCallProfile;->mMediaProfile:Lcom/android/ims/ImsStreamMediaProfile;

    .line 1864
    const-string/jumbo v2, "ImsPhone"

    const-string/jumbo v3, "RTT: packRttModifyRequestToProfile"

    invoke-static {v2, v3}, Landroid/telephony/Rlog;->d(Ljava/lang/String;Ljava/lang/String;)I

    .line 1865
    invoke-virtual {p0, v0}, Lcom/android/internal/telephony/imsphone/ImsPhone;->sendRttModifyRequest(Lcom/android/ims/ImsCallProfile;)V
...
.method public canProcessRttReqest()Z
    .locals 3
    ...
    invoke-static {v0}, Lorg/codeaurora/ims/utils/QtiImsExtUtils;->isRttSupported(Landroid/content/Context;)Z
    ...
    const-string/jumbo v2, "RTT: canProcessRttReqest RTT is not supported/off"
    ...
    const-string/jumbo v2, "RTT: canProcessRttReqest rtt supported = "
    ...
    invoke-static {v2}, Lorg/codeaurora/ims/utils/QtiImsExtUtils;->isRttSupported(Landroid/content/Context;)Z
    ...
    .line 1920
    const-string/jumbo v2, ", is Rtt on = "
    ...
    .line 1921
    const-string/jumbo v2, ", Rtt mode = "
    ...
    invoke-static {v2}, Lorg/codeaurora/ims/utils/QtiImsExtUtils;->getRttMode(Landroid/content/Context;)I
...
.method public isFgCallActive()Z
    ...
    const-string/jumbo v1, "RTT: isFgCallActive fg call not active"
...
.method public isRttVtCallAllowed(Lcom/android/ims/ImsCall;)Z
    ...
    const-string/jumbo v3, "RTT: isRttVtCallAllowed mode = "
    ...
    invoke-virtual {v1}, Lcom/android/ims/ImsCallProfile;->isVideoCall()Z
...
.method public sendRttMessage(Ljava/lang/String;)V
    ...
    const-string/jumbo v3, "RTT: Text null"
    ...
    const-string/jumbo v3, "RTT: imsCall null"
    ...
    .line 1777
    :cond_2
    invoke-virtual {p0, v1}, Lcom/android/internal/telephony/imsphone/ImsPhone;->isRttVtCallAllowed(Lcom/android/ims/ImsCall;)Z
    ...
    const-string/jumbo v3, "RTT: InCorrect mode"
    ...
    const-string/jumbo v3, "RTT: sendRttMessage"

    invoke-static {v2, v3}, Landroid/telephony/Rlog;->d(Ljava/lang/String;Ljava/lang/String;)I

    .line 1784
    :try_start_0
    invoke-virtual {v1, p1}, Lcom/android/ims/ImsCall;->sendRttMessage(Ljava/lang/String;)V
    :try_end_0
    .catch Lcom/android/ims/ImsException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    const-string/jumbo v4, "RTT: sendRttMessage exception = "
...
.method public sendRttModifyRequest(Lcom/android/ims/ImsCallProfile;)V
    ...
    const-string/jumbo v3, "RTT: sendRttModifyRequest"
    ...
    :cond_0
    :try_start_0
    invoke-virtual {v1, p1}, Lcom/android/ims/ImsCall;->sendRttModifyRequest(Lcom/android/ims/ImsCallProfile;)V
    :try_end_0
    .catch Lcom/android/ims/ImsException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    const-string/jumbo v4, "RTT: sendRttModifyRequest exception = "
...
.method public sendRttModifyResponse(I)V
    ...
    const-string/jumbo v3, "RTT: Not allowed for VT"
    ...
    const-string/jumbo v3, "RTT: sendRttModifyResponse"
    ...
    invoke-virtual {v1, v2}, Lcom/android/ims/ImsCall;->sendRttModifyResponse(Z)V
    :try_end_0
    .catch Lcom/android/ims/ImsException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    const-string/jumbo v4, "RTT: sendRttModifyResponse exception = "

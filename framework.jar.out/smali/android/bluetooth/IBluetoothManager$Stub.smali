...
.field static final TRANSACTION_setBrEdrEnableStatus:I = 0x12
...
.method public onTransact(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    invoke-virtual {v0, v2}, Landroid/bluetooth/IBluetoothManager$Stub;->registerAdapter(Landroid/bluetooth/IBluetoothManagerCallback;)Landroid/bluetooth/IBluetooth;

    move-result-object v11

    .line 56
    .local v11, "_result":Landroid/bluetooth/IBluetooth;
    ...
    .end local v11    # "_result":Landroid/bluetooth/IBluetooth;
    :sswitch_2
    const-string/jumbo v15, "android.bluetooth.IBluetoothManager"
    ...
    invoke-virtual {v0, v2}, Landroid/bluetooth/IBluetoothManager$Stub;->unregisterAdapter(Landroid/bluetooth/IBluetoothManagerCallback;)V
    ...
    invoke-virtual {v0, v3}, Landroid/bluetooth/IBluetoothManager$Stub;->registerStateChangeCallback(Landroid/bluetooth/IBluetoothStateChangeCallback;)V
    ...
    invoke-virtual {v0, v3}, Landroid/bluetooth/IBluetoothManager$Stub;->unregisterStateChangeCallback(Landroid/bluetooth/IBluetoothStateChangeCallback;)V
    ...
    invoke-virtual {v0, v5}, Landroid/bluetooth/IBluetoothManager$Stub;->enable(Ljava/lang/String;)Z
    ...
    invoke-virtual {v0, v5}, Landroid/bluetooth/IBluetoothManager$Stub;->enableNoAutoConnect(Ljava/lang/String;)Z
    ...
    invoke-virtual {v0, v5, v8}, Landroid/bluetooth/IBluetoothManager$Stub;->disable(Ljava/lang/String;Z)Z
    ...
    .line 139
    .local v12, "_result":Landroid/bluetooth/IBluetoothGatt;
    invoke-virtual/range {p3 .. p3}, Landroid/os/Parcel;->writeNoException()V
    ...
    .line 145
    .end local v12    # "_result":Landroid/bluetooth/IBluetoothGatt;
    :sswitch_b
    const-string/jumbo v15, "android.bluetooth.IBluetoothManager"
    ...
    invoke-virtual {v0, v1, v7}, Landroid/bluetooth/IBluetoothManager$Stub;->bindBluetoothProfileService(ILandroid/bluetooth/IBluetoothProfileServiceConnection;)Z
    ...
    invoke-virtual {v0, v1, v7}, Landroid/bluetooth/IBluetoothManager$Stub;->unbindBluetoothProfileService(ILandroid/bluetooth/IBluetoothProfileServiceConnection;)V
    ...
    invoke-virtual {v0, v4, v8, v9}, Landroid/bluetooth/IBluetoothManager$Stub;->updateBleAppCount(Landroid/os/IBinder;ZLjava/lang/String;)I
    ...
    invoke-virtual {v0, v6}, Landroid/bluetooth/IBluetoothManager$Stub;->setBrEdrEnableStatus(Z)V
